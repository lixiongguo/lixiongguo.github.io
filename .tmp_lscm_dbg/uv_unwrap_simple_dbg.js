...
function findWasmBinary() {
  return locateFile("uv_unwrap_simple_dbg.wasm");
}
...
var _solve_lscm = Module["_solve_lscm"] = makeInvalidEarlyAccess("_solve_lscm");

var _get_uv_result_size = Module["_get_uv_result_size"] = makeInvalidEarlyAccess("_get_uv_result_size");

var _get_uv_result = Module["_get_uv_result"] = makeInvalidEarlyAccess("_get_uv_result");

var _get_last_time_ms = Module["_get_last_time_ms"] = makeInvalidEarlyAccess("_get_last_time_ms");

var _dbg_vertex_count = Module["_dbg_vertex_count"] = makeInvalidEarlyAccess("_dbg_vertex_count");

var _dbg_face_count = Module["_dbg_face_count"] = makeInvalidEarlyAccess("_dbg_face_count");

var _dbg_edge_count = Module["_dbg_edge_count"] = makeInvalidEarlyAccess("_dbg_edge_count");

var _dbg_halfedge_count = Module["_dbg_halfedge_count"] = makeInvalidEarlyAccess("_dbg_halfedge_count");

var _dbg_boundary_loops = Module["_dbg_boundary_loops"] = makeInvalidEarlyAccess("_dbg_boundary_loops");

var _dbg_isolated_vertices = Module["_dbg_isolated_vertices"] = makeInvalidEarlyAccess("_dbg_isolated_vertices");
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports["solve_lscm"] != "undefined", "missing Wasm export: solve_lscm");
  assert(typeof wasmExports["get_uv_result_size"] != "undefined", "missing Wasm export: get_uv_result_size");
  assert(typeof wasmExports["get_uv_result"] != "undefined", "missing Wasm export: get_uv_result");
  assert(typeof wasmExports["get_last_time_ms"] != "undefined", "missing Wasm export: get_last_time_ms");
  assert(typeof wasmExports["dbg_vertex_count"] != "undefined", "missing Wasm export: dbg_vertex_count");
  assert(typeof wasmExports["dbg_face_count"] != "undefined", "missing Wasm export: dbg_face_count");
  assert(typeof wasmExports["dbg_edge_count"] != "undefined", "missing Wasm export: dbg_edge_count");
  assert(typeof wasmExports["dbg_halfedge_count"] != "undefined", "missing Wasm export: dbg_halfedge_count");
  assert(typeof wasmExports["dbg_boundary_loops"] != "undefined", "missing Wasm export: dbg_boundary_loops");
  assert(typeof wasmExports["dbg_isolated_vertices"] != "undefined", "missing Wasm export: dbg_isolated_vertices");
  ...
  _solve_lscm = Module["_solve_lscm"] = createExportWrapper("solve_lscm", 6);
  _get_uv_result_size = Module["_get_uv_result_size"] = createExportWrapper("get_uv_result_size", 0);
  _get_uv_result = Module["_get_uv_result"] = createExportWrapper("get_uv_result", 0);
  _get_last_time_ms = Module["_get_last_time_ms"] = createExportWrapper("get_last_time_ms", 0);
  _dbg_vertex_count = Module["_dbg_vertex_count"] = createExportWrapper("dbg_vertex_count", 0);
  _dbg_face_count = Module["_dbg_face_count"] = createExportWrapper("dbg_face_count", 0);
  _dbg_edge_count = Module["_dbg_edge_count"] = createExportWrapper("dbg_edge_count", 0);
  _dbg_halfedge_count = Module["_dbg_halfedge_count"] = createExportWrapper("dbg_halfedge_count", 0);
  _dbg_boundary_loops = Module["_dbg_boundary_loops"] = createExportWrapper("dbg_boundary_loops", 0);
  _dbg_isolated_vertices = Module["_dbg_isolated_vertices"] = createExportWrapper("dbg_isolated_vertices", 0);
...
if (typeof exports === 'object' && typeof module === 'object') {
  module.exports = UvUnwrapSimpleDbg;
  // This default export looks redundant, but it allows TS to import this
  // commonjs style module.
  module.exports.default = UvUnwrapSimpleDbg;
} else if (typeof define === 'function' && define['amd'])
  define([], () => UvUnwrapSimpleDbg);
